...
## how it began?
initially, i kinda wanted to build a CLI tool that could index my entire machine in a vector database. i could then easily perform semantic search
